...
const PaymentMethod: FC<Props> = ({
  ...
  useEffect(() => {
    if (active) {
      sendPaymentData({ number:cardNumber, 
        name: cardHolderName,
        //@ts-ignore
  ...
  }, [cardNumber, cardHolderName, expirationDate, cvc, active]);

  const setMethodActiveCard = (e: ChangeEvent<HTMLInputElement>) => {
